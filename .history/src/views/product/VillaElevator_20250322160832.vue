...
.web .web-header .web-header-box .web-header-box2 {
    ...
    top: 17.0003px;
    bottom: -17.0003px;
    box-shadow: 0px 3.9998px 3.9998px 0px rgba(0, 0, 0, 0.18);
...
.web .web-center .web-left {
    width: 141px;
    height: 87.8667vh;
    border-bottom: 0.9998px solid rgba(184, 183, 183, 0.09);
    border-left: 0.9998px solid rgba(184, 183, 183, 0.09);
    border-right: 0.9998px solid rgba(184, 183, 183, 0.09);
    border-radius: 120px 120px 120px 0px;
    box-shadow: 0px 3.9998px 5.0002px 0px rgba(0, 0, 0, 0.1);
    background: rgb(255, 255, 255);
    display: flex;
    flex-direction: column;
...
.web .web-center .web-left .navigation {
    width: 155.0002px;
    height: 11.3333vh;
    border-radius: 0px 50.0002px 50.0002px 0px;
    background: white;
    font-size: 20.0003px;
