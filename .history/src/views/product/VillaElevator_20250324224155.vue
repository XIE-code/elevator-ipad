...
.web .web-center .web-text .web-passenger-product .web-passenger-product-box .web-passenger-product-box-img {
    width: 40%;
    height: 99%;
    background: pink;
    background-size: cover;
...
.web .web-center .web-text .web-passenger-product .web-passenger-product-box .web-passenger-product-box-img img {
    width: 100%;
    height: 100%;
    object-fit: cover;
}

.web .web-center .web-text .web-passenger-product .web-passenger-product-box .web-passenger-product-box-text {
    width: 60%;
    height: 100%;
    background: pink
</style>
