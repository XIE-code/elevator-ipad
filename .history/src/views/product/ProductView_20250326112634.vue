            ...
            <div class="web-text">
                ...
                <div class="center-box" style="margin-top: 1.25rem">
                    ...
                    <div
                        ...
                        v-for="(product, index) in elevatorProducts"
                        :key="index"
                    >
                        <div class="web-passenger-product-box">
                            ...
                            <div class="web-passenger-product-box-text">
                                <span class="text4">{{ product.name }}</span
                                ><br />
                                <span
                                    class="text5"
                                    v-for="(
                                ...
                                >
                                    {{ detail }} </span
                                ><br />
                                <span class="text5">{{ product.floor }}</span>
                                <div
                                    class="web-passenger-product-box-text-bottom"
                                >
                                    <a :href="product.link" class="button-link"
                                        >720°展示</a
                                    >
                                </div>
                            </div>
...
const elevatorProducts = ref([
    {
        ...
        floor: '地板: PVC',
        image: '@/assets/images/elevator_images/image01.png',
    ...
    },
    {
        ...
        floor: '地板: PVC',
        image: '@/assets/images/elevator_images/image02.jpg',
