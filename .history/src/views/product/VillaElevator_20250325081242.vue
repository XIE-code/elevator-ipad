...
html {
    font-size: calc(9.9997px + 0.5vw); /* 动态调整字体大小 */
}
.web {
    width: 100vw;
    height: 100vh;
...
.web .web-center .web-text .web-passenger-product {
    ...
    box-sizing: border-box;
    border: 0.9998px solid rgba(0, 0, 0, 0.24);
    background: rgb(255, 255, 255);
}
...
@media screen and (max-width: 1200px) {
    html {
        font-size: 20.0003px; /* iPad Pro */
    }
}

@media screen and (max-width: 819.9997px) {
    html {
        font-size: 18px; /* iPad */
    }
}
...
@media screen and (max-width: 480px) {
    html {
        font-size: 15.9998px; /* 大屏手机 */
    }
}

@media screen and (max-width: 429.9998px) {
    html {
        font-size: 15px; /* 中等屏手机 */
    }
}

@media screen and (max-width: 414px) {
    html {
        font-size: 15px; /* 常规小屏手机 */
    }
}

@media screen and (max-width: 23.5rem) {
    html {
        font-size: 9.9997px; /* 超小屏手机 */
    }
}
</style>
