<template>
    <div class="web">
        ...
        <div class="web-center">
            <!-- 左侧边导航栏 -->
            <div class="web-left">
                <div class="navigation" @click="setActive(0)">
                    <span class="text6">• 乘客电梯</span><br />
                    <span class="text7">passenger elevator</span>
                </div>
                <div class="navigation" @click="setActive(1)">
                ...
                <div class="web-passenger">
                    ...
                    <div class="web-passenger-text">
                        <div class="web-passenger-text1">
                            ...
                            <hr style="border: 0.1875rem solid rgba(0, 43, 125, 0.85);" />
                            <span class="text3"
                        ...
                        <div class="web-passenger-product-box">
                            ...
                            <div class="web-passenger-product-box-text">
                                ...
                                <div class="web-passenger-product-box-text-bottom">
                                    <a href="http://my.3vfang.com/p/share/content.php?m=a3I4MDM5LWl0ZW09NTE2OTQ="
                                        class="button-link"
                                        >720度展示</a
                                    </div>
                            </div>
        ...
        <!-- 中心部分 -->
        <div class="web-center">
            <div class="web-center-elevator">1</div>
            <div class="web-center-elevator">1</div>
            <div class="web-center-elevator">1</div>
        </div>
    </div>
...
const setActive = (index) => {
    // 移除所有导航项的高亮样式
    document.querySelectorAll('.web-left .navigation').forEach(item => {
        item.classList.remove('active');
    });

    // 为当前点击的导航项添加高亮样式
    document.querySelectorAll('.web-left .navigation')[index].classList.add('active');
};

onMounted(() => {
    console.log(document.querySelectorAll('.web-left .navigation'));
});
</script>
...
.web-left .navigation:hover,
.web-left .navigation.active {
    background-color: red; /* 高亮时的背景颜色 */
}
</style>