        ...
        <div class="web-center">
            ...
            <nav className="w-full">
                <ul className="space-y-4">
                    <li
                        className="relative p-3 text-blue-700 font-bold rounded-l-full bg-blue-200 flex items-center"
                    >
                        <span className="ml-4">• 乘客电梯</span>
                        <span className="ml-auto text-sm text-gray-500"
                            >passenger elevator</span
                        >
                    </li>
                    <li
                        className="p-3 text-gray-700 font-bold flex items-center"
                    >
                        <span className="ml-4">• 别墅电梯</span>
                        <span className="ml-auto text-sm text-gray-500"
                            >Villa elevator</span
                        >
                    </li>
            ...
            <div class="web-text">
                ...
                <div class="center-title">
                    <span>PRODUCT</span>
                    <span>[ 佳登曼电梯|产品中心 ]</span>
                </div>
                <div class="web-passenger">3</div>
                <div class="web-passenger-product">4</div>
            </div>
        </div>
...
.web .web-center .web-left .navigation1 {
    width: 155px;
    height: 85px;
    background: pink;
...
.web .web-center .web-left .navigation2 {
    width: 155px;
    height: 85px;
    background: pink;
    border-radius: 0px 50px 50px 0px;
    background: rgba(0, 43, 125, 0.85);
}
